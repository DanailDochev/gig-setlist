    ...
    >
      ...
      <div
        style={{
          ...
          opacity: m ? 1 : 0,
          transform: m ? "translateY(0)" : "translateY(18px)",
        }}
      >
        <div
          style={{
...
function CigaretteIcon({ color = "#b89968", size = 52 }) {
  return (
    ...
    >
      ...
      {/* curly smoke wisps */}
      <path
        d="M81 13 C 78 8, 83 4, 79 -1"
        stroke={color}
        strokeWidth="1.1"
        fill="none"
        opacity="0.75"
        style={{
          animation: "smokeCurl 3.6s ease-in-out infinite",
          transformOrigin: "81px 13px",
        }}
      />
      <path
        d="M84 12 C 87 6, 82 2, 86 -3"
        stroke={color}
        strokeWidth="1.0"
        fill="none"
        opacity="0.65"
        style={{
          animation: "smokeCurl 4.8s ease-in-out 0.4s infinite",
          transformOrigin: "84px 12px",
        }}
      />
      <path
        d="M87 13 C 90 7, 86 3, 90 -2"
        stroke={color}
        strokeWidth="0.85"
        fill="none"
        opacity="0.55"
        style={{
          animation: "smokeCurl 3.9s ease-in-out 0.9s infinite",
          transformOrigin: "87px 13px",
        }}
      />
      <path
        d="M83 11 C 80 5, 85 1, 81 -4"
        stroke={color}
        strokeWidth="0.75"
        fill="none"
        opacity="0.45"
        style={{
          animation: "smokeCurl 5.5s ease-in-out 1.5s infinite",
          transformOrigin: "83px 11px",
        }}
      />
      <path
        d="M86 12 C 90 5, 85 0, 89 -5"
        stroke={color}
        strokeWidth="0.6"
        fill="none"
        opacity="0.35"
        style={{
          animation: "smokeCurl 4.2s ease-in-out 2.1s infinite",
          transformOrigin: "86px 12px",
        }}
      />
      <path
        d="M80 13 C 77 6, 82 2, 78 -3"
        stroke={color}
        strokeWidth="0.5"
        fill="none"
        opacity="0.28"
        style={{
          animation: "smokeCurl 6.0s ease-in-out 0.7s infinite",
          transformOrigin: "80px 13px",
        }}
      />
    </svg>
  );
...
function WineGlass({ color = "#b89968", size = 54, fill = 0.55 }) {
  return (
    <svg width={size} height={size * 1.5} viewBox="0 0 60 90" fill="none">
      ...
      />
      <path
        d="M14 6 Q 14 42 30 44 Q 46 42 46 6 Z"
        stroke={color}
        strokeWidth="1.2"
        fill="none"
      />
...
function LyricView({
  ...
  return (
    ...
    >
      ...
      <div
        style={{ position: "relative", zIndex: 2, padding: "18px 22px 10px" }}
      >
        ...
        <svg
          ...
          style={{ display: "block", marginTop: 12, opacity: 0.35 }}
        >
          <path
            d="M0 7 Q 40 2 80 7 Q 120 12 160 7 Q 200 2 240 7 Q 280 12 320 7"
            stroke={theme.accent}
            strokeWidth="0.8"
            fill="none"
          />
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 320 18"
          preserveAspectRatio="none"
          style={{ display: "block", marginBottom: 12, opacity: 0.4 }}
        >
          <line
            x1="0"
            y1="9"
          ...
          />
          <path
            d="M138 9 Q145 3 152 9 Q159 15 166 9"
            stroke={theme.accent}
            strokeWidth="0.7"
            fill="none"
          />
        ...
        <svg
          ...
          viewBox="0 0 320 28"
          preserveAspectRatio="none"
          style={{ display: "block", marginTop: 24, opacity: 0.3 }}
        >
          <line
            x1="0"
            y1="14"
...
const RIDDLE_TEXT  = "Забавление, при което ентусиасти пеят под акомпанимента на известни песни, само инструментала. Обикновено има сцена с микрофон и екран, на който се показва текста на песента заедно с музиката.";
...
function RiddleView({ theme, onBack, onSolved }) {
  ...
  const guess = (letter) => {
    ...
    setGuessed(next);
    if (RIDDLE_WORD.includes(letter)) {
      setFlash(letter);
      setTimeout(() => setFlash(null), 650);
      if (RIDDLE_WORD.every((l, i) => RIDDLE_SHOWN.has(i) || next.has(l))) {
        setTimeout(() => { setSolved(true); setTimeout(onSolved, 1500); }, 400);
      }
    } else {
      setWiggle(letter);
  ...
  const wrongCount = [...guessed].filter(l => !RIDDLE_WORD.includes(l)).length;

  return (
    <div style={{ position:"absolute", inset:0, background:theme.bg, overflowY:"auto" }}>
      <div style={{ padding:"44px 22px 52px", display:"flex", flexDirection:"column", gap:24 }}>

        {/* back */}
        <button onClick={onBack} style={{
          alignSelf:"flex-start", background:"transparent", border:"none",
          fontFamily:"var(--mono)", fontSize:9, letterSpacing:4,
          color:theme.muted, textTransform:"uppercase", cursor:"pointer", padding:0,
        }}>← назад</button>

        {/* heading */}
        <div>
          <div style={{ fontFamily:"var(--mono)", fontSize:9, letterSpacing:6,
            color:theme.accent, textTransform:"uppercase", marginBottom:10 }}>
            Финалната загадка
          </div>
          <div style={{ fontFamily:"var(--serif-text)", fontStyle:"italic",
            fontSize:13.5, lineHeight:1.72, color:theme.fg, opacity:0.7 }}>
            {RIDDLE_TEXT}
          </div>
        </div>
        ...
        {/* word */}
        <div style={{ display:"flex", gap:7, justifyContent:"center", padding:"10px 0" }}>
          {RIDDLE_WORD.map((letter, i) => {
            const visible = RIDDLE_SHOWN.has(i) || guessed.has(letter);
            const preset  = RIDDLE_SHOWN.has(i);
            ...
            return (
              <div key={i} style={{ textAlign:"center", width:32 }}>
                ...
                <div style={{
                  ...
                  background: visible ? (preset ? theme.muted : theme.accent) : `${theme.hair}cc`,
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8 }}>
          <span style={{ fontFamily:"var(--mono)", fontSize:8, letterSpacing:3,
            color:theme.muted, textTransform:"uppercase" }}>Грешки</span>
        ...
        {!solved && (
          <>
            <div style={{ fontFamily:"var(--mono)", fontSize:8, letterSpacing:4,
              color:theme.muted, textTransform:"uppercase", textAlign:"center" }}>
              Избери буква
            </div>
            <div style={{ display:"flex", flexWrap:"wrap", gap:8, justifyContent:"center" }}>
              {RIDDLE_ALPHA.map(letter => {
                const used      = guessed.has(letter);
                const isCorrect = used && RIDDLE_WORD.includes(letter);
                const isWrong   = used && !RIDDLE_WORD.includes(letter);
                return (
  ...
  return (
    ...
    >
      ...
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        />
        <path
          d="M8 9 L16 9 M14 9 L14 12 M12 9 L12 11"
          stroke="currentColor"
          strokeWidth="1"
...
// ---------- Main ----------
window.FilmicApp = function FilmicApp({
  themeMode = "dark",
  fontSize = 19,
  aesthetic = "editorial",
}) {
  ...
  const songIndexes = program
    .map((p, i) => (p.type === "song" ? i : -1))
    .filter((i) => i >= 0);
  ...
  const doLock = () => {
    try {
      localStorage.removeItem("setlist-secret-unlocked");
    } catch (e) {}
    setUnlocked(false);
  };
    ...
    >
      ...
      {screen === "song" && current && current.type === "song" && (
        <LyricView
          ...
          onBack={() => setScreen("program")}
          onPrev={() => {
            if (hasPrev) setActiveIdx(songIndexes[songPos - 1]);
          }}
          onNext={() => {
            if (hasNext) setActiveIdx(songIndexes[songPos + 1]);
          }}
          hasPrev={hasPrev}
          hasNext={hasNext}
        />
