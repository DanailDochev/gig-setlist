  ...
  return (
    ...
    >
      ...
      <path
        ...
        opacity="0.55"
        style={{
          animation: "smokeCurl 4s ease-in-out infinite",
          transformOrigin: "82px 13px",
        }}
      />
      <path
        d="M85 12 C 88 7, 84 4, 87 0"
        stroke={color}
        strokeWidth="0.65"
        fill="none"
        opacity="0.38"
        style={{
          animation: "smokeCurl 5.2s ease-in-out 0.6s infinite",
          transformOrigin: "85px 12px",
        }}
      />
      <path
        d="M89 13 C 91 8, 88 5, 91 1"
        stroke={color}
        strokeWidth="0.5"
        fill="none"
        opacity="0.25"
        style={{
          animation: "smokeCurl 3.8s ease-in-out 1.1s infinite",
          transformOrigin: "89px 13px",
        }}
      />
    </svg>
  );
