...
export function Cover({ theme, coverPhoto, onEnter }) {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: theme.bg, color: theme.fg, overflow: 'hidden' }}>
      <PhotoBg src={coverPhoto} shade={0.68} pos="50% 28%" scale={mounted ? 1.22 : 1.35} blur={0}/>
      <Grain o={0.28}/>
      ...
      <div style={{
        ...
        <div style={{
          ...
          color: theme.accent, textTransform: 'uppercase', marginBottom: 16, fontWeight: 700
        }}>
          Дани Дочев — на живо
        </div>
        <div style={{
          fontFamily: 'var(--display)', fontSize: 82, fontWeight: 300,
        ...
        <div style={{
          ...
          transform: mounted ? 'scaleX(1)' : 'scaleX(0)', transformOrigin: 'left'
        }}/>
        <div style={{
          fontFamily: 'var(--serif-text)', fontSize: 15, lineHeight: 1.55,
          color: theme.fg, marginTop: 18, opacity: 0.72, maxWidth: 290, fontStyle: 'italic'
        }}>
