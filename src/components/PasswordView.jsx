...
export function PasswordView({ theme, pin, onBack, onUnlock }) {
  ...
  return (
    <div style={{
      ...
      display: 'flex', flexDirection: 'column', padding: '0 22px', overflow: 'hidden'
    }}>
      <div style={{
      ...
      <div style={{
        ...
        <div style={{
          fontFamily: 'var(--mono)', fontSize: 10, letterSpacing: 4, color: theme.accent,
          textTransform: 'uppercase', textAlign: 'center', marginBottom: 10
        }}>
          Скрит сет
        </div>
        <div style={{
          fontFamily: 'var(--display)', fontSize: 30, fontWeight: 300, fontStyle: 'italic',
          letterSpacing: '-0.02em', textAlign: 'center', lineHeight: 1.1, marginBottom: 8
        }}>
          Въведи PIN
        </div>
        <div style={{
          fontFamily: 'var(--serif-text)', fontSize: 12, color: theme.muted, fontStyle: 'italic',
          textAlign: 'center', marginBottom: 22, maxWidth: 240, alignSelf: 'center', lineHeight: 1.5
        }}>
        ...
        <div style={{
          ...
          textAlign: 'center', textTransform: 'uppercase', minHeight: 14, marginBottom: 18
        }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  fontSize: isBack ? 18 : 26, fontWeight: 300,
