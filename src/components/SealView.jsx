      ...
      <div style={{
        ...
        >
          ...
          <div style={{
            ...
            opacity: shatter ? 0 : 1, transition: 'opacity 0.35s'
          }}>
            Д
          </div>
          {shatter && (
        ...
        <div style={{
          ...
          fontStyle: 'italic', textAlign: 'center', marginTop: 36, minHeight: 20
        }}>
          {shatter ? 'отворено ✦' : progress === 0 ? 'задръж печата' : progress < 1 ? '...още малко' : 'счупено'}
        </div>
      </div>
    </div>
  );
